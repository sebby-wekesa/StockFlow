      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color: 'var(--muted)', fontSize: '14px', lineHeight: 1.5, marginBottom: '24px' }}>
            Your organization signup for{' '}
            <span style={{ fontFamily: 'var(--font-mono)', color: 'var(--text)' }}>{submittedEmail}</span>{' '}
            is waiting for approval. You can sign in after it is approved.
          </p>
          <Link
            href="/login"
            style={{
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ color: 'var(--muted)', fontSize: '13px', marginBottom: '24px', lineHeight: 1.4 }}>
          Create a new organization and its owner account. Team members must be invited after approval.
        </p>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
          ...
          <div className="form-group">
            <label className="form-label">Primary branch name</label>
            <input
              type="text"
              name="branchName"
              required
          ...
          >
            {isPending ? 'Submitting organization...' : 'Register organization'}
          </button>
        </form>
