  ...
  return (
    <div>
      ...
      {role === "ADMIN" && stats.admin && (
        <>
          <RunwayAlerts inventory={stats.admin.inventory} />
          <div className="grid-3 mb-6">
            <div className="stat-card amber">
              <div className="stat-label">Pending Approvals</div>
              <div className="stat-value">{stats.admin.pendingOrders}</div>
            ...
            <div className="stat-card">
              ...
              <div className="stat-value">{stats.admin.designs}</div>
            ...
            <div className="stat-card">
              ...
              <div className="stat-value">{stats.admin.users}</div>
